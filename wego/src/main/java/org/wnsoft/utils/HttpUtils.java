...
//下面发送数据结束标志，表示数据已经结束
    ...
    public HttpRespons postJson(String path, Map<String
            , String> parameters, String json) throws IOException {
        ...
        for (String key : parameters.keySet()) {
            ...
            urlString += key + "=" + URLEncoder.encode(parameters.get(key), encoding);
            i++;
        }
        ...
        outStream.flush();
        outStream.close();
        return makeContent(urlString, conn);
    }
